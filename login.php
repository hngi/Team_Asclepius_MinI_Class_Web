...
<div class="register_login-content" id="login-form">
  <form action="login.php" method="POST">
    ...
    <div id="error_message">
      <?php
      if (isset($_SESSION['mail-mgs'])) {
        echo "<h5 class='alert alert-success text-center mt-5'>" . $_SESSION['mail-mgs'] . "</h5>";
        unset($_SESSION['mail-mgs']);
      }
      ?>
      <?php
    ...
    <p> <a href="forget_password.php" class="text-danger">Forget Password</a></p>
  </form>
</div>
